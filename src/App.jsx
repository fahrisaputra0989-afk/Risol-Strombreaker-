          ...
          <div className="slide">
            ...
            <div className="card">
              ...
              <label style={{ display: "block", border: "2px dashed #FFD49A", borderRadius: 14, padding: 20, textAlign: "center", cursor: "pointer", background: "#FFFDF8", transition: "all .15s" }}
                ...
                onDrop={e => { e.preventDefault(); const f = e.dataTransfer.files[0]; if (f) { setProofFile(f); setProofPreview(URL.createObjectURL(f)); } }}>
            ...
            {!dashUnlocked ? (
              ...
              <>
                ...
                <div className="card" style={{ overflowX: "auto" }}>
                  ...
                  {loadingOrders
                    ? <div style={{ textAlign: "center", padding: 30, color: "#A0856A" }}>Loading...</div>
                    : orders.length === 0
                      ? <div style={{ textAlign: "center", padding: 30, color: "#A0856A" }}>Belum ada pesanan 📭</div>
                      : orders.map(o => (
